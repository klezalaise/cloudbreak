...
public class EnvironmentVariableConfig {
    ...
    public static final String CB_AZURE_RM_IMAGE = new StringBuilder()
            ...
            .append(String.format("NORTH_EUROPE:https://02589fae040d8westeurope2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
    ...
    public static final String CB_AWS_AMI_MAP = new StringBuilder()
            .append("ap-northeast-1:ami-e91a3087,")
            .append("ap-southeast-1:ami-9918dbfa,")
            .append("ap-southeast-2:ami-c64e15a5,")
            .append("eu-central-1:ami-7fccd013,")
            .append("eu-west-1:ami-502d8e23,")
            .append("sa-east-1:ami-4fd25523,")
            .append("us-east-1:ami-8ed19be4,")
            .append("us-west-1:ami-864a21e6,")
            .append("us-west-2:ami-970f10f6")
            .toString();
    public static final String CB_OPENSTACK_IMAGE = "cb-centos71-amb212-2015-12-15";
    public static final String CB_GCP_SOURCE_IMAGE_PATH = "sequenceiqimage/cb-centos71-amb212-2015-12-15.tar.gz";
