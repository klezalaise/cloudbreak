            ...
            <div class="panel-body">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row " style="padding-bottom: 10px">
                                <div class="btn-segmented-control" id="providerSelector2">
                                    ...
                                    <div class="btn-group btn-group-justified" ng-if="isVisible('GCP') || isVisible('OPENSTACK')||isVisible('WAP')">
					...
					<a id="openstackNetworkChange" ng-if="isVisible('OPENSTACK')" ng-class="{'btn':true, 'btn-info':openstackNetwork, 'btn-default':!openstackNetwork}" role="button" ng-click="createOpenstackNetworkRequest()">{{msg.openstack_label}}</a>
					 <a id="WAPNetworkChange" ng-if="isVisible('WAP')" ng-class="{'btn':true, 'btn-info':wapNetwork, 'btn-default':!wapNetwork}" role="button" ng-click="createWapNetworkRequest()">{{msg.wap_label}}</a>
